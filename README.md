...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fuzzymatcher-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11351&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fuzzymatcher-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fuzzymatcher` can be installed with:

```
conda install fuzzymatcher
```

It is possible to list all of the versions of `fuzzymatcher` available on your platform with:
